...
public class RegistrationForm extends JFrame implements ActionListener{
   ...
   public static ImageIcon resizeImageIcon(String imagePath, int width, int height) {
	...
	JLabel fnameLabel = new JLabel("PASSWORD");
	JLabel mnameLabel = new JLabel("PASSWORD");
    ...
    public JPanel rightPanel() {
        ...
        fnameLabel.setBounds(40, 165,40,40);
       
        fname.setBounds(40,173,145,25);
        fname.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        // USERNAME TEXTFIELD
        loginPanelRight.add(username);
        username.setBounds(80, 270, 145, 25); // adjust spacing
        ...
        password.setBounds(80, 370, 145, 25);
